...
for n_interventions in reversed(range(0, d+1, 5)):
    ...
    n_epochs = 5_000
    # gamma = 10
    gammas = list(np.linspace(0, 50, n_epochs))
    ...
    wandb.init(
        ...
        name=f"{n_interventions / d:.2f}_interventions_no_prescreen_gamma_search_slow",
        config={
            "seed": seed,
            "n": n,
            "d": d,
